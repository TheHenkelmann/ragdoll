...
export function IconStages({ size = 16, className }: IconProps) {
  return (
...
export function IconReleases({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
...
export function IconModels({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
...
export function IconBackup({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
...
export function IconProfile({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
...
export function IconPlayground({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
...
export function IconSources({ size = 16, className }: IconProps) {
  return (
    <svg {...strokeProps(size)} className={className}>
